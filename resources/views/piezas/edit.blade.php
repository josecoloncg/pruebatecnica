...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="mb-6">
        <h1 class="text-2xl font-semibold text-gray-800">✏️ Editar Pieza</h1>
    </div>
        ...
        <form action="{{ route('piezas.update', $pieza->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <select name="proyecto_id" 
                    ...
                    @foreach($proyectos as $proyecto)
                        <option value="{{ $proyecto->id }}" {{ old('proyecto_id', $pieza->proyecto_id) == $proyecto->id ? 'selected' : '' }}>
            ...
            <div class="mb-4">
                ...
                <select name="bloque_id" 
                    ...
                    @foreach($bloques as $bloque)
                        <option value="{{ $bloque->id }}" data-proyecto="{{ $bloque->proyecto_id }}" {{ old('bloque_id', $pieza->bloque_id) == $bloque->id ? 'selected' : '' }}>
            ...
            <div class="mb-4">
                ...
                <input type="number" 
                       name="peso_teorico" 
                       id="peso_teorico" 
                       value="{{ old('peso_teorico', $pieza->peso_teorico) }}" 
                       required
                       step="0.01"
                       min="0"
            ...
            <div class="mb-4">
                ...
                <input type="number" 
                       name="peso_real" 
                       id="peso_real" 
                       value="{{ old('peso_real', $pieza->peso_real) }}" 
                       step="0.01"
                       min="0"
